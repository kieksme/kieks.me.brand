...
The complete SIL Open Font License 1.1 can be found at: <https://scripts.sil.org/OFL>
...
**Designer:** Paul D. Hunt (Adobe Systems)  
...
1. **Free to Use:** Fonts can be used for any purpose, including commercial projects
2. **Modification Allowed:** Fonts can be modified and distributed
3. **No Warranty:** Fonts are provided "as is" without warranty
4. **Attribution:** Original copyright notices must be preserved
5. **No Selling:** Fonts cannot be sold by themselves (but can be included in products)
...
When using these fonts, please include appropriate attribution:

- **Hanken Grotesk:** Copyright 2020 The Hanken Grotesk Project Authors (<https://github.com/marcopradil/hanken-grotesk>)
- **Source Sans 3:** Copyright 2010-2021 Adobe Systems Incorporated (<http://www.adobe.com/>), with Reserved Font Name 'Source'. Copyright 2021 Source Foundry Authors (<https://github.com/adobe-fonts/source-sans>)

---

## Additional Resources

- [SIL Open Font License FAQ](https://scripts.sil.org/OFL_web)
- [Google Fonts License Information](https://fonts.google.com/about)
- [Hanken Grotesk on GitHub](https://github.com/marcopradil/hanken-grotesk)
- [Source Sans 3 on GitHub](https://github.com/adobe-fonts/source-sans)
